---
description: >-
  Connect your Notion workspace to Arkain and let the AI build apps and
  containers using your actual project docs — no copy-pasting required.
icon: mcp
---

# Connect External Tools

<figure><img src="../../../.gitbook/assets/mcp (1).png" alt=""><figcaption></figcaption></figure>
...
On the Dashboard page, click the **connector icon** (<img src="../../../.gitbook/assets/ActivityBar-item (3).png" alt="" data-size="line">) in the bottom-left corner of the Snap and the Side Chat(Dashboard) input box to open the **Connect your tools** popup.
