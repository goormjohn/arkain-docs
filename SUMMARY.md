...
* [Workspace](user-guide/workspace/README.md)
  ...
  * [Source Code Management Git](user-guide/workspace/source-code-management-git/README.md)
    ...
    * [Historys](user-guide/workspace/source-code-management-git/historys.md)
...
* [Dashboard](user-guide/dashboard/README.md)
  * [Container](user-guide/dashboard/container/README.md)
    ...
    * [Container Stacks](user-guide/dashboard/container/container-stacks.md)
    ...
    * [Container Managing](user-guide/dashboard/container/container-managing/README.md)
      ...
      * [Import Github Repos](user-guide/dashboard/container/container-managing/import-github-repos.md)
      * [Configuring Container](user-guide/dashboard/container/container-managing/configuring-container/README.md)
        * [Init Script](user-guide/dashboard/container/container-managing/configuring-container/init-script.md)
        * [Environment Variables](user-guide/dashboard/container/container-managing/configuring-container/environment-variables.md)
        * [Container Upgrade](user-guide/dashboard/container-managing/configuring-container/container-upgrade.md)
      * [Container Run / Stop / Delete](user-guide/dashboard/container-managing/container-run-stop-delete.md)
...
* [Side chat : AI code assistant](user-guide/side-chat-ai-code-assistant/README.md)
  * [How to use Side Chat](user-guide/side-chat-ai-code-assistant/how-to-use-side-chat.md)
  * [Supported Models](user-guide/side-chat-ai-code-assistant/supported-models.md)
  * [Code Auto Complete](user-guide/side-chat-ai-code-assistant/code-auto-complete.md)
