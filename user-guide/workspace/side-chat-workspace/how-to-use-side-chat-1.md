...
You can also **select the** [**LLM model**](../../arkain-ai/supported-models.md) you want to use before submitting your input.
...
* Enable [**AI Supporter**](../../arkain-ai/ai-supporter.md) to make the AI automatically reference the most relevant files.
{% endhint %}
