...
{% hint style="warning" %}
**Warnning**\
Even if you close the web browser, the container will remain running. **While the container is running,** [**credits**](../../pricing/credits/) **will be consumed.** It is recommended to click the **\[EXIT]** button to exit Arkain.
{% endhint %}
