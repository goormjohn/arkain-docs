---
description: >-
  Keyboard shortcuts are the simplest and most effective way to save time and
  boost develop
icon: keyboard
---
...
| Function                  | macOS Shortcut                                         | Windows/Linux Shortcut                           |
| ------------------------- | ------------------------------------------------------ | ------------------------------------------------ |
| Run Command               | <kbd>F5</kbd>                                          | <kbd>F5</kbd>                                    |
| Refresh Project Explorer  | <kbd>Cmd ⌘</kbd> + <kbd>R</kbd>                        | <kbd>Ctrl</kbd> + <kbd>R</kbd>                   |
| Open Preview in Workspace | <kbd>option ⌥</kbd> +<kbd>Shift ⌘</kbd> + <kbd>J</kbd> | <kbd>Alt</kbd> + <kbd>Shift</kbd> + <kbd>J</kbd> |
| Find File                 | <kbd>Cmd ⌘</kbd> + <kbd>P</kbd>                        | <kbd>Ctrl</kbd> + <kbd>P</kbd>                   |
| Open Preferences          | <kbd>option ⌥</kbd> + <kbd>P</kbd>                     | <kbd>Alt</kbd> + <kbd>P</kbd>                    |
...
| Function           | macOS Shortcut                  | Windows/Linux Shortcut         |
| ------------------ | ------------------------------- | ------------------------------ |
| View All Shortcuts | <kbd>Cmd ⌘</kbd> + <kbd>H</kbd> | <kbd>Ctrl</kbd> + <kbd>H</kbd> |
